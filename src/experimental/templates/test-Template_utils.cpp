...
int main(int argc, char* argv[]) {
   ...
   // std::cout << "rank " << Find<int, std::tuple<int, double, int>>::value <<
   // std::endl; // compilation fails <int, double, int> is not a set
   // std::cout << "rank " << Find<float, std::tuple<int, double, char>>::value
   // << std::endl; // compilation fails float not in <int, double, int>
   std::cout << "rank " << Find<int, std::tuple<int, double, char>>::value
             << std::endl;
   std::cout << "rank " << Find<double, std::tuple<int, double, char>>::value
             << std::endl;
   std::cout << "rank " << Find<char, std::tuple<int, double, char>>::value
             << std::endl;
