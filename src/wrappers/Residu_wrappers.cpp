...
extern "C"
{
    void Residu_associate_pointers(
...
struct Residuals
{
    ...
    auto nodes_accumulation_end() { return accumulations.data() + fractures_offset;}
    auto fractures_accumulation_size() const { return fractures_size();}
    auto fractures_accumulation_begin() { return accumulations.data() + nodes_accumulation_size();}
    auto fractures_accumulation_end() { return accumulations.data() + fractures_accumulation_size();}
    auto cells_accumulation_size() const { return cells_size();}
    auto cells_accumulation_begin() { return accumulations.data() + cells_offset;}
    auto cells_accumulation_end() { return accumulations.data() + cells_accumulation_size();}
    ...
    void reset() {
        ...
        Residu_associate_pointers(
            { nodes_begin(), nodes_size() },
            { fractures_begin(), fractures_size() },
            { cells_begin(), cells_size() },
            { injectors_begin(), injectors_size() },
...
void add_Residu_wrappers(py::module& module)
{
    ...
    .def_property_readonly("own_nodes", [](Residuals& self) {
        return py::array_t<double>{
            { self.own_nodes_size(), Residuals::npv() }, self.nodes_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("fractures", [](Residuals& self) {
        return py::array_t<double>{
            { self.fractures_size(), Residuals::npv() }, self.fractures_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("own_fractures", [](Residuals& self) {
        return py::array_t<double>{
            { self.own_fractures_size(), Residuals::npv() }, self.fractures_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("cells", [](Residuals& self) {
        return py::array_t<double>{
            { self.cells_size(), Residuals::npv() }, self.cells_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("own_cells", [](Residuals& self) {
        return py::array_t<double>{
            { self.own_cells_size(), Residuals::npv() }, self.cells_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("nodes_accumulation", [](Residuals& self) {
        return py::array_t<double>{
            { self.nodes_size(), Residuals::npv() }, self.nodes_accumulation_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("fractures_accumulation", [](Residuals& self) {
        return py::array_t<double>{
            { self.fractures_size(), Residuals::npv() }, self.fractures_accumulation_begin()
        };
    }, py::keep_alive<0, 1>())
    .def_property_readonly("cells_accumulation", [](Residuals& self) {
        return py::array_t<double>{
