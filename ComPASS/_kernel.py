...
simulation_wrapper = Wrapper([
    ...
    "get_cell_porosity_buffer",
    "get_cell_heat_source_buffer",
    "get_fracture_porosity_buffer",
    "get_cell_permeability_buffer",
    "get_fracture_permeability_buffer",
    "get_cell_thermal_conductivity_buffer",
    "get_fracture_thermal_conductivity_buffer",
    "Psat",
    "Tsat",
