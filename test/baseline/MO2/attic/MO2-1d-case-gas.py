...
qw = 3.0  # total production flow rate (for the whole reservoir i.e. theta = 2pi)
pres = 4 * bar  # reservoir pressure
Tres = degC2K(350)  # reservoir temperature
...
simulation.standard_loop(
    initial_timestep=1e-5 * day, final_time=day, output_period=hour, nitermax=2
)
