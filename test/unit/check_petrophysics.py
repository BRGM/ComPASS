...
simulation.init(
    mesh=grid,
    cell_permeability=1.0,  # Dummy value
    cell_porosity=0.5,  # Dummy value
    cell_thermal_conductivity=1.0,  # Dummy value
    fracture_permeability=1.0,  # Dummy value
    fracture_porosity=0.5,  # Dummy value
    fracture_thermal_conductivity=1.0,  # Dummy value
