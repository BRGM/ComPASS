...
# atm BC at the top with lot of water in farfield
# water enters and liquid appears
# gravity = 0
...
X0 = simulation.build_state(simulation.Context.gas, p=patm, T=Tinit, Cag=1.0)
X_bottom = simulation.build_state(simulation.Context.gas, p=pbot, T=Tinit, Cag=1.0)
X_top = simulation.build_state(
    simulation.Context.gas_FF_no_liq_outflow, p=patm, T=Tinit, Cag=1.0
)
...
# change the molar fraction of the far-field with Cwg = 0.8
phase_molar_fraction = [[0.2, 0.8], [0.0, 1.0]]
ff_ns = simulation.freeflow_node_states()
ff_ns.C[is_ff] = phase_molar_fraction

tsmger = TimeStepManager(
    initial_timestep=0.02 * year,
