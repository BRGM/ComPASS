...
final_time = 10.
standard_loop(
    fixed_timestep=1., final_time=final_time,
...
def dump_solution(filename='solution.vtu'):
    ...
    MT.to_vtu(
        ...
        celldata={
            ...
            'uvol': u(ComPASS.compute_cell_centers()) * ((2*np.pi)**3/ ComPASS.number_of_cells()),
        },
    )
dump_solution('toto')

for s in ['cellthermalsource', 'nodethermalsource', 'porovolfouriercell', 'porovolfouriernode']:
    a = getattr(ComPASS, s)()
