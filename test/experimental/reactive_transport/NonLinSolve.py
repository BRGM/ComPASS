...
def nonlin_solve(
    ...
    condition = nls.TerminationCondition(
...
def _nonlin_line_search(func, x, Fx, dx, search_type="armijo", rdiff=1e-8, smin=1e-2):
    ...
    if search_type == "wolfe":
        s, phi1, phi0 = nls.scalar_search_wolfe1(
            phi, derphi, tmp_phi[0], xtol=1e-2, amin=smin
        )
    elif search_type == "armijo":
        s, phi1 = nls.scalar_search_armijo(phi, tmp_phi[0], -tmp_phi[0], amin=smin)
