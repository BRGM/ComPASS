...
{
	typedef std::remove_reference<Input>::type Input_type;
...
PYBIND11_PLUGIN(C3t3Wrapper)
{

	py::module module("C3t3Wrapper", "pybind11 homemade CGAL C3t3 interface");
