...
"
  ...
  find_path(
    ...
    HINTS "${PETSC_DIR}"
    PATH_SUFFIXES "${PETSC_ARCH}/include" "bmake/${PETSC_ARCH}" NO_DEFAULT_PATH
  )
  ...
  mark_as_advanced(
    PETSC_INCLUDES PETSC_LIBRARIES PETSC_COMPILER PETSC_DEFINITIONS
...
# -----------------------------------------------------------------------
# The following is specific to ComPASS Export duplicate variables for compliance
# with PETSc pkg-config support
set(DUPLICATED_VARIABLES FOUND LIBRARIES VERSION)
